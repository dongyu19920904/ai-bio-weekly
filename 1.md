...
🔥 **这周发生了什么**：Google DeepMind 用 AI 找到了第一个从未被发现过的新抗癌靶点，而且从实验室到临床试验仅用30个月——比行业平均速度快 17 倍。
...
**这张照片的妙处**：米象甲与米粒的并列，既展示了这一农业害虫的真实大小（仅0.3毫米），又完整地揭示了它的生态角色——一个在全球范围内破坏谷物收成的微观对手。每条细微的触须、每片透明的翅膀纹理，都在显微镜下变成了艺术品。

为了捕捉这一瞬间的完美细节，张友用一台中画幅相机配合**5倍显微镜物镜**，进行了**100多张照片的焦点叠加**，花费两周时间进行清洁、打光和后期处理。

**启示**：这张图片提醒我们——真正的科学摄影既需要深刻的主题理解，也需要无尽的耐心和艺术眼光。显微镜下的世界从不缺少美，只是缺少**真正愿意停下来观察的人**。
...
如果这个趋势持续，我们可能正在进入一个**生物学发现被AI显著加速的时代**。

但前提是：我们能够确保这些AI系统的预测真正被**实验验证**，而不是被盲目相信。
...
✅ **战略思维**（第5篇）- 思考AI在科学发现中的长期角色

✅ **核心启示** - 这周的深度阅读集中在一个主题：**不是AI替代科学家，而是AI如何赋能科学家**
...
**启示**：AI不仅能加速"已知"，更能**发现"未知"**的新靶点和新作用机制。
...
**启示**：**人+AI的完美范例**——AI将科学家从重复性筛选中解放出来，让他们专注于高价值决策。
...
**启示**：**从"单个靶点中心"到"整体生物学系统理解"**的范式转变。可能真的有机会逆转Eroom's Law。
